                ...
                <form action="" role="form text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 align-self-center">
                            ...
                            <button id="btnkategori" class="btn btn-primary" style="margin-bottom: 0;"> + </button>
                        </div>
                        ...
                        <div class="col-md-1 align-self-center">
                            ...
                            <button id="btnklien" class="btn btn-primary" style="margin-bottom: 0;"> + </button>
                        </div>
                        ...
                        <div class="col-md-1 align-self-center">
                            ...
                            <button id="btnrekening" class="btn btn-primary" style="margin-bottom: 0; "> + </button>
                        </div>
                    </div>
